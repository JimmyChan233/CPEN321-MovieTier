/**
 * @unit Unit tests for friend controller functions
...
import { streamFriends } from "../../../src/controllers/friend/friendController";
...
describe("Unit: Friend Controller - streamFriends", () => {
