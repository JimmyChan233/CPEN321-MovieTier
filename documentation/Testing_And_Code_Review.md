...
| --------------- | --------------------- | ------------- |
| 2025-11-10 | 4.1 (Frontend Test Locations) | **Fixed Frontend E2E Test File Reference**: Corrected test file name in Section 4.1 from `SendFriendRequestByNameTest.kt` to actual file name `SendFriendRequestByNameE2ETest.kt` to match the actual implementation in the codebase. All three main feature tests are fully implemented and passing. |
