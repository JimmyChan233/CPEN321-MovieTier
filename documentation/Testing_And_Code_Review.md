...
| --- | --- | --- | --- |
| **POST /api/auth/signin** | [`backend/tests/api/unmocked/auth/auth.test.ts`](../../backend/tests/api/unmocked/auth/auth.test.ts) | [`backend/tests/api/mocked/auth/auth.test.ts`](../../backend/tests/api/mocked/auth/auth.test.ts) | Google OAuth client, JWT generation, User model |
| **POST /api/auth/signup** | [`backend/tests/api/unmocked/auth/auth.test.ts`](../../backend/tests/api/unmocked/auth/auth.test.ts) | [`backend/tests/api/mocked/auth/auth.test.ts`](../../backend/tests/api/mocked/auth/auth.test.ts) | Google OAuth client, JWT generation, User model |
| **POST /api/auth/signout** | [`backend/tests/api/unmocked/auth/auth.test.ts`](../../backend/tests/api/unmocked/auth/auth.test.ts) | [`backend/tests/api/mocked/auth/auth.test.ts`](../../backend/tests/api/mocked/auth/auth.test.ts) | JWT verification, User model |
| **DELETE /api/auth/account** | [`backend/tests/api/unmocked/auth/auth.test.ts`](../../backend/tests/api/unmocked/auth/auth.test.ts) | [`backend/tests/api/mocked/auth/auth.test.ts`](../../backend/tests/api/mocked/auth/auth.test.ts) | User model, cascading deletes |
| **GET /api/movies/search** | [`backend/tests/api/unmocked/movies/movies.test.ts`](../../backend/tests/api/unmocked/movies/movies.test.ts) | [`backend/tests/api/mocked/movies/search.test.ts`](../../backend/tests/api/mocked/movies/search.test.ts) | TMDB API client |
| **GET /api/movies/ranked** | [`backend/tests/api/unmocked/movies/movies.test.ts`](../../backend/tests/api/unmocked/movies/movies.test.ts) | [`backend/tests/api/mocked/movies/movies.test.ts`](../../backend/tests/api/mocked/movies/movies.test.ts) | RankedMovie model |
| **POST /api/movies/add** | [`backend/tests/api/unmocked/movies/ranking.test.ts`](../../backend/tests/api/unmocked/movies/ranking.test.ts) | [`backend/tests/api/mocked/movies/ranking.test.ts`](../../backend/tests/api/mocked/movies/ranking.test.ts) | RankedMovie model, Watchlist model, SSE service |
| **POST /api/movies/compare** | [`backend/tests/api/unmocked/movies/ranking.test.ts`](../../backend/tests/api/unmocked/movies/ranking.test.ts) | [`backend/tests/api/mocked/movies/ranking.test.ts`](../../backend/tests/api/mocked/movies/ranking.test.ts) | Comparison session, RankedMovie model, FeedActivity model |
| **POST /api/movies/rerank/start** | [`backend/tests/api/unmocked/movies/reranking.test.ts`](../../backend/tests/api/unmocked/movies/reranking.test.ts) | [`backend/tests/api/mocked/movies/ranking.test.ts`](../../backend/tests/api/mocked/movies/ranking.test.ts) | Comparison session, RankedMovie model |
| **DELETE /api/movies/ranked/:id** | [`backend/tests/api/unmocked/movies/movies.test.ts`](../../backend/tests/api/unmocked/movies/movies.test.ts) | [`backend/tests/api/mocked/movies/movies.test.ts`](../../backend/tests/api/mocked/movies/movies.test.ts) | RankedMovie model, FeedActivity model |
| **GET /api/friends** | [`backend/tests/api/unmocked/friends/friends.test.ts`](../../backend/tests/api/unmocked/friends/friends.test.ts) | [`backend/tests/api/mocked/friends/friends.test.ts`](../../backend/tests/api/mocked/friends/friends.test.ts) | Friendship model |
| **GET /api/friends/requests** | [`backend/tests/api/unmocked/friends/friends.test.ts`](../../backend/tests/api/unmocked/friends/friends.test.ts) | [`backend/tests/api/mocked/friends/friends.test.ts`](../../backend/tests/api/mocked/friends/friends.test.ts) | FriendRequest model |
| **GET /api/friends/requests/detailed** | [`backend/tests/api/unmocked/friends/friends.test.ts`](../../backend/tests/api/unmocked/friends/friends.test.ts) | [`backend/tests/api/mocked/friends/friends.test.ts`](../../backend/tests/api/mocked/friends/friends.test.ts) | FriendRequest model, User model |
| **GET /api/friends/requests/outgoing** | [`backend/tests/api/unmocked/friends/friends.test.ts`](../../backend/tests/api/unmocked/friends/friends.test.ts) | [`backend/tests/api/mocked/friends/friends.test.ts`](../../backend/tests/api/mocked/friends/friends.test.ts) | FriendRequest model |
| **GET /api/friends/requests/outgoing/detailed** | [`backend/tests/api/unmocked/friends/friends.test.ts`](../../backend/tests/api/unmocked/friends/friends.test.ts) | [`backend/tests/api/mocked/friends/friends.test.ts`](../../backend/tests/api/mocked/friends/friends.test.ts) | FriendRequest model, User model |
| **POST /api/friends/request** | [`backend/tests/api/unmocked/friends/friends.test.ts`](../../backend/tests/api/unmocked/friends/friends.test.ts) | [`backend/tests/api/mocked/friends/friends.test.ts`](../../backend/tests/api/mocked/friends/friends.test.ts) | FriendRequest model, notification service |
| **POST /api/friends/respond** | [`backend/tests/api/unmocked/friends/friends.test.ts`](../../backend/tests/api/unmocked/friends/friends.test.ts) | [`backend/tests/api/mocked/friends/friends.test.ts`](../../backend/tests/api/mocked/friends/friends.test.ts) | FriendRequest model, Friendship model, notification service |
| **DELETE /api/friends/:friendId** | [`backend/tests/api/unmocked/friends/friends.test.ts`](../../backend/tests/api/unmocked/friends/friends.test.ts) | [`backend/tests/api/mocked/friends/friends.test.ts`](../../backend/tests/api/mocked/friends/friends.test.ts) | Friendship model |
| **GET /api/feed** | [`backend/tests/api/unmocked/feed/feed.test.ts`](../../backend/tests/api/unmocked/feed/feed.test.ts) | [`backend/tests/api/mocked/feed/feed.test.ts`](../../backend/tests/api/mocked/feed/feed.test.ts) | FeedActivity model, Friendship model, TMDB client |
| **GET /api/feed/me** | [`backend/tests/api/unmocked/feed/feed.test.ts`](../../backend/tests/api/unmocked/feed/feed.test.ts) | [`backend/tests/api/mocked/feed/feed.test.ts`](../../backend/tests/api/mocked/feed/feed.test.ts) | FeedActivity model, TMDB client |
| **GET /api/feed/stream** | [`backend/tests/api/unmocked/feed/stream.test.ts`](../../backend/tests/api/unmocked/feed/stream.test.ts) | [`backend/tests/api/mocked/feed/feed.test.ts`](../../backend/tests/api/mocked/feed/feed.test.ts) | SSE service |
| **POST /api/feed/:activityId/like** | [`backend/tests/api/unmocked/feed/interactions.test.ts`](../../backend/tests/api/unmocked/feed/interactions.test.ts) | [`backend/tests/api/mocked/feed/feed.test.ts`](../../backend/tests/api/mocked/feed/feed.test.ts) | Like model, FeedActivity model, notification service |
| **DELETE /api/feed/:activityId/like** | [`backend/tests/api/unmocked/feed/interactions.test.ts`](../../backend/tests/api/unmocked/feed/interactions.test.ts) | [`backend/tests/api/mocked/feed/feed.test.ts`](../../backend/tests/api/mocked/feed/feed.test.ts) | Like model, FeedActivity model |
| **GET /api/feed/:activityId/comments** | [`backend/tests/api/unmocked/feed/interactions.test.ts`](../../backend/tests/api/unmocked/feed/interactions.test.ts) | [`backend/tests/api/mocked/feed/feed.test.ts`](../../backend/tests/api/mocked/feed/feed.test.ts) | Comment model |
| **POST /api/feed/:activityId/comments** | [`backend/tests/api/unmocked/feed/interactions.test.ts`](../../backend/tests/api/unmocked/feed/interactions.test.ts) | [`backend/tests/api/mocked/feed/feed.test.ts`](../../backend/tests/api/mocked/feed/feed.test.ts) | Comment model, FeedActivity model, notification service |
| **GET /api/recommendations** | [`backend/tests/api/unmocked/recommendations/recommendations.test.ts`](../../backend/tests/api/unmocked/recommendations/recommendations.test.ts) | [`backend/tests/api/mocked/recommendations/recommendations.test.ts`](../../backend/tests/api/mocked/recommendations/recommendations.test.ts) | TMDB discover API, RankedMovie model |
| **GET /api/recommendations/trending** | [`backend/tests/api/unmocked/recommendations/recommendations.test.ts`](../../backend/tests/api/unmocked/recommendations/recommendations.test.ts) | [`backend/tests/api/mocked/recommendations/recommendations.test.ts`](../../backend/tests/api/mocked/recommendations/recommendations.test.ts) | TMDB API client |
| **GET /api/watchlist** | [`backend/tests/api/unmocked/watchlist/watchlist.test.ts`](../../backend/tests/api/unmocked/watchlist/watchlist.test.ts) | [`backend/tests/api/mocked/watchlist/watchlist.test.ts`](../../backend/tests/api/mocked/watchlist/watchlist.test.ts) | WatchlistItem model, TMDB client |
| **POST /api/watchlist** | [`backend/tests/api/unmocked/watchlist/watchlist.test.ts`](../../backend/tests/api/unmocked/watchlist/watchlist.test.ts) | [`backend/tests/api/mocked/watchlist/watchlist.test.ts`](../../backend/tests/api/mocked/watchlist/watchlist.test.ts) | WatchlistItem model, TMDB client |
| **DELETE /api/watchlist/:movieId** | [`backend/tests/api/unmocked/watchlist/watchlist.test.ts`](../../backend/tests/api/unmocked/watchlist/watchlist.test.ts) | [`backend/tests/api/mocked/watchlist/watchlist.test.ts`](../../backend/tests/api/mocked/watchlist/watchlist.test.ts) | WatchlistItem model |
| **GET /api/users/search** | [`backend/tests/api/unmocked/users/users.test.ts`](../../backend/tests/api/unmocked/users/users.test.ts) | [`backend/tests/api/mocked/auth/auth.test.ts`](../../backend/tests/api/mocked/auth/auth.test.ts) | User model |
| **PUT /api/users/profile** | [`backend/tests/api/unmocked/users/profile.test.ts`](../../backend/tests/api/unmocked/users/profile.test.ts) | [`backend/tests/api/mocked/auth/auth.test.ts`](../../backend/tests/api/mocked/auth/auth.test.ts) | User model |
| **POST /api/users/fcm-token** | [`backend/tests/api/unmocked/users/profile.test.ts`](../../backend/tests/api/unmocked/users/profile.test.ts) | [`backend/tests/api/mocked/auth/auth.test.ts`](../../backend/tests/api/mocked/auth/auth.test.ts) | User model |
| **GET /api/users/:userId** | [`backend/tests/api/unmocked/users/users.test.ts`](../../backend/tests/api/unmocked/users/users.test.ts) | [`backend/tests/api/mocked/auth/auth.test.ts`](../../backend/tests/api/mocked/auth/auth.test.ts) | User model |
| **GET /api/movies/quote** | [`backend/tests/unit/controllers/movieQuoteController.test.ts`](../../backend/tests/unit/controllers/movieQuoteController.test.ts) | [`backend/tests/api/mocked/services/apis.test.ts`](../../backend/tests/api/mocked/services/apis.test.ts) | TMDB tagline API |
| **GET /api/movies/:movieId/details** | [`backend/tests/api/unmocked/movies/movies.test.ts`](../../backend/tests/api/unmocked/movies/movies.test.ts) | [`backend/tests/api/mocked/movies/movies.test.ts`](../../backend/tests/api/mocked/movies/movies.test.ts) | TMDB API client |
| **GET /api/friends/stream** | [`backend/tests/api/unmocked/feed/stream.test.ts`](../../backend/tests/api/unmocked/feed/stream.test.ts) | [`backend/tests/api/mocked/feed/feed.test.ts`](../../backend/tests/api/mocked/feed/feed.test.ts) | SSE service |
| **DELETE /api/friends/requests/:requestId** | [`backend/tests/api/unmocked/friends/friends.test.ts`](../../backend/tests/api/unmocked/friends/friends.test.ts) | [`backend/tests/api/mocked/friends/friends.test.ts`](../../backend/tests/api/mocked/friends/friends.test.ts) | FriendRequest model, notification service |
| **DELETE /api/feed/:activityId/comments/:commentId** | [`backend/tests/api/unmocked/feed/interactions.test.ts`](../../backend/tests/api/unmocked/feed/interactions.test.ts) | [`backend/tests/api/mocked/feed/feed.test.ts`](../../backend/tests/api/mocked/feed/feed.test.ts) | Comment model |
| **GET /api/users/:userId/watchlist** | [`backend/tests/api/unmocked/watchlist/watchlist.test.ts`](../../backend/tests/api/unmocked/watchlist/watchlist.test.ts) | [`backend/tests/api/mocked/watchlist/watchlist.test.ts`](../../backend/tests/api/mocked/watchlist/watchlist.test.ts) | WatchlistItem model, User model |
...
`35c8f84` - Latest commit on main branch (Nov 27, 2025) with final testing documentation and verified stats
